...
conn.sendImageAsSticker(m.chat, pickRandom(stikerhuuu), m, { packname: "⌬ Lexa Bot", author: "6282253479547" })
}

handler.customPrefix = /^(huuu|ajg|asu|bot|kntl|anj|sepi|rame|anjay)$/i
